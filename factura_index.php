                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="cobroscabecera.php" class="btn btn-danger btn-sm"
                                           data-title="Cobrar" rel="tooltip"> <i class="fa fa-money"> </i> Cobrar</a>
                                        <a href="factura_add.php" class="btn btn-success btn-sm"
                                           data-title="Agregar" rel="tooltip"> <i class="fa fa-plus"> </i> Agregar factura</a>
                                        <a href="factura_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip"
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="factura_index.php" method="post" accept-charset="utf8"
                                            ...
                                            <?php
                                            $factura = consultas::get_datos("SELECT * FROM v_factura WHERE fac_estado = 'PENDIENTE' AND fac_fecha::text ILIKE '%%' ORDER BY fac_cod DESC;");
                                            if ($factura) {
                                                ?>
