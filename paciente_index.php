...
<?php } ?>
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        ...
                                        <a href="paciente_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip" data-placement="left" target="print">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            <?php
                                           $pacientes = consultas::get_datos("select * from v_paciente where (paciente) ilike '%" . (isset($_REQUEST['buscar']) ? $_REQUEST['buscar'] : "") . "%' order by pac_cod");
    ...
    <?php foreach ($pacientes as $paciente) { ?>
                                                                <tr>
                                                                    <td data-title="#"><?php echo $paciente['pac_cod']; ?></td>
                                                                    <td data-title="Paciente"><?php echo $paciente['paciente']; ?></td>
                                                                    <td data-title="CI"><?php echo $paciente['per_ci']; ?></td>
                                                                    <td data-title="Nacionalidad"><?php echo $paciente['nac_descri']; ?></td>
                                                                    <td data-title="Telefono"><?php echo $paciente['per_telefono']; ?></td>
                                                                    <td data-title="Email"><?php echo $paciente['per_email']; ?></td>
                                                                    <td data-title="Estado"><?php echo $paciente['paciente_estado']; ?></td>
                                                                    <td data-title="Acciones" class="text-center">
        <?php if ($paciente['paciente_estado'] == 'ACTIVO') { ?>
                                                                            <a onclick="editar('<?php echo $paciente['pac_cod'] . "_" . $paciente['paciente']; ?>')"       
                                                                            ...
                                                                            <a onclick="deshabilitar('<?php echo $paciente['pac_cod'] . "_" . $paciente['paciente']; ?>')" 
        ...
        <?php } else { ?>
                                                                            <a onclick="activar('<?php echo $paciente['pac_cod'] . "_" . $paciente['paciente']; ?>')" 
            ...
            <div class="modal fade" id="registrar" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                       ...
                       <form action="paciente_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
...
<?php require 'menu/js_lte.ctp'; ?><!--ARCHIVOS JS-->
        ...
        <script>
            ...
            function deshabilitar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'paciente_control.php?vpac_cod=' + dat[0] + '&vper_cod=' + dat[1] + '&accion=3');
            ...
            function activar(datos) {
                ...
                var url = 'paciente_control.php?accion=4&vpac_cod=' + vpac_cod + '&vper_cod=' + vpac_cod + '&vpac_estado=' + vpac_estado;
                // Actualizar el enlace 'si' con la URL correcta
                $('#si_activar').attr('href', url);

                // Configurar el mensaje de confirmación
                var mensaje = 'Desea activar datos del Paciente <strong>' + dat[1] + '</strong>?';
