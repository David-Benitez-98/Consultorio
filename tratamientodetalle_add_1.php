                                                        ...
                                                        <?php foreach ($detalletratamientos as $detalles) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a onclick="confirmar('<?php echo $detalles['cod_consulta'] . "_" . $detalles['sin_descri']; ?>')" 
                                                                    ...
                                                                    <a onclick="editar(<?php echo $detalles['cod_consulta'] . "_" . $detalles['sin_descri']; ?>)"
                                                                       class="btn btn-warning btn-sm" data-title="Editar" rel="tooltip" data-placement="left" data-toggle="modal" data-target="#editar">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a> 
                                                                    <a onclick="borrar('<?php echo $detalles['cod_consulta'] . "_" . $detalles['sin_descri']; ?>', '<?php echo $detalles['tra_fechainicio']; ?>', '<?php echo $detalles['tra_fechafin']; ?>')" 
