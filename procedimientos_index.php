...
<html>
    <head>
        ...
        <title>Procedimientos e Insumos Utilizados - Sistema Consultorio</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Procedimientos e Insumos Utilizados</h3>
                                    <div class="box-tools">
                                        <a href="procedimientos_add.php" class="btn btn-success btn-sm" data-title="Agregar" rel="tooltip">
                                            <i class="fa fa-plus"></i> Agregar Procedimientos/Insumos Utilizados
                                        </a>
                                        
                                        <a href="procedimientos_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="procedimientos_index.php" method="post" accept-charset="utf8" class="form-horizontal">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                            <div class="input-group custom-search-form">
                                                                <input type="search" class="form-control" name="buscar" placeholder="Buscar..." autofocus=""/>
                                                                <a href="procedimientos_add.php"></a>
                                            ...
                                            <?php
                                            $tratamiento = consultas::get_datos("SELECT * FROM v_procedimientos WHERE proce_fecha::text ILIKE '%%' ORDER BY proce_cod desc;");
                                            ...
                                            <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                ...
                                                <tbody>
                                                    <?php foreach ($tratamiento as $trat) { ?>
                                                        <tr>
                                                            <td data-title="#"><?php echo $trat['proce_cod']; ?></td>
                                                            <td data-title="Fecha"><?php echo $trat['proce_fecha']; ?></td>
                                                            <td data-title="Paciente"><?php echo $trat['paciente']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['tipoproce_descri']; ?></td>
                                                             <td data-title="Estado"><?php echo $trat['proce_estado']; ?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <?php if ($trat['proce_estado'] == 'PENDIENTE') { ?>
                                                                  
                                                                    <a href="procedimientosdetalle_add.php?vproce_cod=<?php echo $trat['proce_cod']; ?>" 
                                                                       class="btn btn-success btn-sm" role="button" data-title="Detalles" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-list"></span></a>
                                                                    
                                                                    <a onclick="anular(<?php echo "'".$trat['proce_cod']."_".$trat['paciente']."_".$trat['proce_fecha']."'";?>)"
                                                                ...
                                                                <?php } ?>
                                                                <a href="citas_print.php?vtra_cod=<?php echo $trat['proce_cod']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Imprimir" 
