                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box box-warning">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">REPORTE DE CONSULTAS</h3>
                            </div>
                            <div class="box-body">
                                <form action="consultas_print.php" method="get" class="form-horizontal" target="print">
                                            ...
                                            <div class="panel panel-warning">
                                                ...
                                                <div class="panel-body">
                                                    <div class="list-group">
                                                        <a href="consultas_rpt.php?opcion=1" class="list-group-item">Por Fechas</a>
                                                        <a href="consultas_rpt.php?opcion=2" class="list-group-item">Por Paciente</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
