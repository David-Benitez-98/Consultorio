                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Agregar Tratamiento</h3>
                                </div>
                                <div class="box-tools">
                                    <a href="tratamiento_index.php" class="btn btn-primary btn-sm float-left" data-title="Volver" rel="tooltip" data-placement="right">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select  name="vdiag_cod" id="paciente_diagnostico" class="form-control" onchange="cargardiagnostico(); return false;">
                                                    ...
                                                    $diagnostico = consultas::get_datos("SELECT DISTINCT
                                                        ...
                                                        WHERE
                                                            d.diag_estado = 'DIAGNOSTICADO'
                                                        GROUP BY
                                                            d.diag_cod, d.pac_cod, per.per_nombre, per.per_apellido;
                                                        ");
                                                    ?>
