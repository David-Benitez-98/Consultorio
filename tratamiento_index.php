...
<html>
    <head>
        ...
        <title>Tratamiento - Sistema Consultorio</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="tratamiento_add.php" class="btn btn-success btn-sm" data-title="Agregar" rel="tooltip">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="tratamiento_index.php" method="post" accept-charset="utf8" class="form-horizontal">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                            <div class="input-group custom-search-form">
                                                                <input type="search" class="form-control" name="buscar" placeholder="Buscar..." autofocus=""/>
                                                                <a href="tratamiento_add.php"></a>
                                            ...
                                            <?php
                                            $tratamiento = consultas::get_datos("SELECT * FROM v_tratamiento WHERE tra_fecha::text ILIKE '%%' ORDER BY tra_cod desc;");
                                            ...
                                            <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                ...
                                                <tbody>
                                                    <?php foreach ($tratamiento as $trat) { ?>
                                                        <tr>
                                                            <td data-title="#"><?php echo $trat['tra_cod']; ?></td>
                                                            ...
                                                            <td data-title="Estado"><?php echo $trat['tipotra_descri']; ?></td>
                                                             <td data-title="Estado"><?php echo $trat['detalle_observ']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['tra_fechainicio']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['tra_fechafin']; ?></td>
                                                             <td data-title="Estado"><?php echo $trat['tra_estado']; ?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <?php if ($trat['tra_estado'] == 'PENDIENTE') { ?>
                                                                    <a href="tratamientodetalle_add.php?vtra_cod=<?php echo $trat['tra_cod']; ?>" 
                                                                       class="btn btn-success btn-sm" role="button" data-title="Detalles" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-list"></span></a>   
                                                                        
                                                                    <a onclick="anular(<?php echo "'".$trat['tra_cod']."_".$trat['paciente']."_".$trat['tra_fecha']."'";?>)"
                                                                ...
                                                                <?php } ?>
                                                                                       <a href="citas_print.php?vtra_cod=<?php echo $trat['tra_cod']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Imprimir" 
