                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Agregar Orden de Estudios</h3>
                                </div>
                                <div class="box-tools">
                                    <a href="ordenestudios_index.php" class="btn btn-primary btn-sm float-left" data-title="Volver" rel="tooltip" data-placement="left">
                                ...
                                <div class="box-body">
                                    <form action="ordenestudios_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                        ...
                                        <input type="hidden" name="voe_cod" value="0">
                                        <!--Inicio de cabecera -->
                                        <div class="row">
                                            <?php
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select  name="vcod_consulta" id="paciente_consulta" class="form-control" onchange="cargarConsulta(); return false;">
                                                    ...
                                                    WHERE
                                                        c.con_fecha = CURRENT_DATE AND c.tipcon_cod = c.tipcon_cod AND c.con_estado = 'HECHO1'");
                                                    ?>
