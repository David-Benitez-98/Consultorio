...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Mantener Personas</h3>
                                    <div class="box-tools">
                                        <!-- Botón para abrir el modal de agregar persona -->
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAgregarPersona">
                                            Agregar
                                        </button>
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            $persona = consultas::get_datos("select * from persona where (per_cod||trim(upper(per_nombre))) like trim(upper('%" . $valor . "%')) order by per_cod");
                                            if (!empty($persona)) {
                                                ?>
                                                <table class="table table-condensed table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($persona as $per) { ?>
                                                            <tr>
                                                                <td data-title="N° Cedula"><?php echo $per['per_ci']; ?></td>
                                                                <td data-title="Nombres y Apellidos"><?php echo $per['per_nombre'] . " " . $per['per_apellido']; ?></td>
                                                                <td data-title="Telefono"><?php echo $per['per_telefono']; ?></td>
                                                                <td data-title="Direccion"><?php echo $per['per_direc']; ?></td>
                                                                <td data-title="Direccion"><?php echo $per['per_estado']; ?></td>
                                                                <td data-title="Acciones" class="text-center">
                                                                    <?php if ($per['per_estado'] == 'ACTIVO') { ?>
                                                                        <a onclick="editar('<?php echo $per['per_cod'] . "_" . $per['per_nombre']; ?>')"       
                                                                        ...
                                                                        <a onclick="deshabilitar('<?php echo $per['per_cod'] . "_" . $per['per_nombre']; ?>')" 
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <a onclick="activar('<?php echo $per['per_cod'] . "_" . $per['per_nombre']; ?>')" 
        ...
        <?php
        $personas = pg_fetch_all(pg_query("SELECT * FROM persona WHERE per_estado = 'ACTIVO' ORDER BY per_cod;"));
        ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modalAgregarPersonaLabel">Agregar Persona</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="personas_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="vper_nombre" required autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-4">Apellido:</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="vper_apellido" required autofocus>
                                </div>
                            </div>
                            <div class="form-group">
