...
<html>
    <head>
        ...
        <title>Justificativo Medico - Sistema Consultorio</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">JUSTIFICATIVO MÉDICO</h3>
                                    <div class="box-tools">
                                        <a href="justificativomedico_add.php" class="btn btn-success btn-sm" data-title="Agregar" rel="tooltip">
                                            <i class="fa fa-plus"></i> Agregar Justificativo Medico
                                        </a>
                                        
                                        <a href="tratamiento_print.php" class="btn btn-default btn-sm" data-title="Imprimir" rel="tooltip">
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="justificativomedico_index.php" method="post" accept-charset="utf8" class="form-horizontal">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                            <div class="input-group custom-search-form">
                                                                <input type="search" class="form-control" name="buscar" placeholder="Buscar..." autofocus=""/>
                                                                <a href="justificativomedico_add.php"></a>
                                            ...
                                            <?php
                                            $tratamiento = consultas::get_datos("SELECT * FROM v_justificativo WHERE justi_fechaemision::text ILIKE '%%' ORDER BY jus_cod desc;");
                                            ...
                                            <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                ...
                                                <tbody>
                                                    <?php foreach ($tratamiento as $trat) { ?>
                                                        <tr>
                                                            <td data-title="#"><?php echo $trat['jus_cod']; ?></td>
                                                            <td data-title="Fecha"><?php echo $trat['justi_fechaemision']; ?></td>
                                                            <td data-title="Paciente"><?php echo $trat['paciente']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['mot_descri']; ?></td>
                                                             <td data-title="Estado"><?php echo $trat['jus_obervacion']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['justi_fechainicio']; ?></td>
                                                            <td data-title="Estado"><?php echo $trat['justi_fechafin']; ?></td>
                                                             <td data-title="Estado"><?php echo $trat['jus_estado']; ?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                                <?php if ($trat['jus_estado'] == 'PENDIENTE') { ?>
                                                                    <a href="justificativodetalle_add.php?vjus_cod=<?php echo $trat['jus_cod']; ?>" 
                                                                       class="btn btn-success btn-sm" role="button" data-title="Detalles" 
                                                                       rel="tooltip" data-placement="top">
                                                                        <span class="glyphicon glyphicon-list"></span></a>   
                                                                        
                                                                    <a onclick="anular(<?php echo "'".$trat['jus_cod']."_".$trat['paciente']."_".$trat['justi_fechaemision']."'";?>)"
                                                                ...
                                                                <?php } ?>
                                                                                       <a href="citas_print.php?vjus_cod=<?php echo $trat['jus_cod']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Imprimir" 
                                         ...
                                         <?php } else { ?>
                                            <div class="alert alert-info">
                                                ...
                                                No se han registrado Justificativos...
                                            </div>      
                                        <?php } ?>
                                    </div>
                                </div>
