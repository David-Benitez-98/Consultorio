                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">NOTA CREDITO/DEBITO</h3>
                                    <div class="box-tools">
                                        <a href="notacreditodebito_add.php" class="btn btn-success btn-sm"
                                           data-title="Agregar" rel="tooltip"> <i class="fa fa-plus"> </i> Agregar Nota Credito/Debito</a>
                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form action="notacreditodebito_index.php" method="post" accept-charset="utf8"
