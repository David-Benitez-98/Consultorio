                                            ...
                                            <div class="box-body">
                                                ...
                                                <div id="dynamicFields">
                                                    ...
                                                    <div class="form-group bloque-efectivo" hidden >
                                                        ...
                                                        <input type="numberic" class="form-control" id="cardNumber" name="vmonto" value="0" placeholder="">
                                                    </div>
                                                    <!--PAGOS EN TARJETA-->
                                                    ...
                                                    <div class="bloque-cheque" hidden>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            ?>
                                                            <select class="form-control" name="ban_cod"  id="ban_cod">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="nro_cheque" id="chequeNumero"  placeholder="Ingrese el número de cheque">
                                                        </div>
                                                        <!-- Campo para la Fecha de Emisión del Cheque -->
                                                        <div class="col-md-6">
                                                            <label for="fechaEmision">Fecha de Emisión:</label>
                                                            <input type="date" class="form-control" name="fecha_emision" id="fechaEmision" >
                                                        </div>

                                                        <!-- Campo para la Fecha de Cobro -->
                                                        <div class="col-md-6">
                                                            <label for="cobroFecha">Fecha de Cobro:</label>
                                                            <input type="date" class="form-control" name="cobro_fecha" id="cobroFecha" >
                                                        </div>

                                                        <!-- Campo para el Titular del Cheque -->
                                                        <div class="col-md-6">
                                                            <label for="titularCheque">Titular:</label>
                                                            <input type="text" class="form-control" name="titular" id="titularCheque"  placeholder="Ingrese el nombre del titular">
                                                        </div>
                                                        <!-- Campo para el Monto -->
                                                        <div class="col-md-6">
...
¿Desea borrar el detalle del cobro para la cuota <strong>' + ctaNroCuota + '</strong> de la factura <strong>' + facCod + '</strong>?');
                            ...
                            function calcularVuelto() {
                                // Define el total de la factura. Puedes obtener este valor desde otro campo o asignarlo manualmente
                                const total = parseFloat(document.getElementById("totalFactura").value) || 0;
                                const efectivo = parseFloat(document.getElementById("efectivo").value) || 0;
                                // Calcula el vuelto
                                const vuelto = efectivo - total;
                                // Muestra el vuelto en el campo correspondiente, si es positivo
                                document.getElementById("vuelto").value = vuelto >= 0 ? vuelto.toFixed(2) : "Efectivo insuficiente";
                            }
