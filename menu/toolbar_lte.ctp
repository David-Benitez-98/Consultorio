    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php if(!empty($_SESSION['usu_imagen'])){ echo $_SESSION['usu_imagen'];}else{ echo "img/1.png";}?>" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/sistema_consultorio/menu.php"><span class="glyphicon glyphicon-home"></span> <strong>Inicio</strong></a></li>
...
<!--                SELECT *
FROM paginas a
JOIN modulos b ON a.mod_cod = b.mod_cod
WHERE b.mod_cod = 4
ORDER BY pag_nombre;-->
